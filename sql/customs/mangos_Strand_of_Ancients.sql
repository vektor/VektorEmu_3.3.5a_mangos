...
-- Need a game test for this item !
...
(@GAMEOBJECT+8, 180058, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+9, 180060, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+10, 180058, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+11, 180060, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1), 
(@GAMEOBJECT+12, 180100, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+13, 180101, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+14, 180100, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+15, 180101, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),
(@GAMEOBJECT+16, 191311, 607, 3, 1, 1337.23, -157.79, 30.8947, 3.51587, 0, 0, 0.982541, -0.186048, 86400, 100, 1),

(@GAMEOBJECT+17, 180058, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1),
(@GAMEOBJECT+18, 180060, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1),
(@GAMEOBJECT+19, 180058, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1),
(@GAMEOBJECT+20, 180060, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1),
(@GAMEOBJECT+21, 180100, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1), 
(@GAMEOBJECT+22, 180101, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1), 
(@GAMEOBJECT+23, 180100, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1), 
(@GAMEOBJECT+24, 180101, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1), 
(@GAMEOBJECT+25, 191311, 607, 3, 1, 1315.55, 11.8483, 31.2072, 2.85221, 0, 0, 0.989551, 0.144186, 86400, 100, 1),

(@GAMEOBJECT+26, 180058, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+27, 180060, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+28, 180058, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+29, 180060, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+30, 180100, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+31, 180101, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+32, 180100, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+33, 180101, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
(@GAMEOBJECT+34, 191311, 607, 3, 1, 1206.8, -68.2148, 70.0845, 3.14279, 0, 0, 1, -0.00059919, 86400, 100, 1), 
...
(20000, 'The battle for Strand of the Ancients begins in 2 minute.', 'NULL', 'NULL', 'NULL'),
(20001, 'The battle for Strand of the Ancients begins in 1 minute.', 'NULL', 'NULL', 'NULL'),
(20002, 'The battle for Strand of the Ancients begins in 30 seconds.', 'NULL', 'NULL', 'NULL'),
(20003, 'The battle for Strand of the Ancients has begun!', 'NULL', 'NULL', 'NULL'),
(20004, 'The %s is under attack!', 'NULL', 'NULL', 'NULL'),
(20005, 'The %s is damaged!', 'NULL', 'NULL', 'NULL'),
(20006, 'The %s was destroyed!', 'NULL', 'NULL', 'NULL'),
(20007, 'Gate of the Green Emerald', 'NULL', 'NULL', 'NULL'),
(20008, 'Gate of the Blue Sapphire', 'NULL', 'NULL', 'NULL'),
(20009, 'Gate of the Purple Amethyst', 'NULL', 'NULL', 'NULL'),
(20010, 'Gate of the Red Sun', 'NULL', 'NULL', 'NULL'),
(20011, 'Gate of the Yellow Moon', 'NULL', 'NULL', 'NULL'),
(20012, 'Chamber of Ancient Relics', 'NULL', 'NULL', 'NULL'),
(20013, 'East graveyard!', 'NULL', 'NULL', 'NULL'),
(20014, 'West graveyard!', 'NULL', 'NULL', 'NULL'),
(20015, 'South graveyard!', 'NULL', 'NULL', 'NULL'),
(20016, '$n placed a Seaforium Charge!', 'NULL', 'NULL', 'NULL'),
(20017, 'The Alliance won the first round, the Relic of Titan was captured!', 'NULL', 'NULL', 'NULL'),
(20018, 'The Horde won the first round, the Relic of Titan was captured!', 'NULL', 'NULL', 'NULL'),
(20019, 'The Alliance won the second round, the Relic of Titan was captured!', 'NULL', 'NULL', 'NULL'),
(20020, 'The Horde won the second round, the Relic of Titan was captured!', 'NULL', 'NULL', 'NULL'),
(20021, 'The Eastern Graveyard has been captured by the Horde!', 'NULL', 'NULL', 'NULL'),
(20022, 'The Western Graveyard has been captured by the Horde!', 'NULL', 'NULL', 'NULL'),
(20023, 'The Southern Graveyard has been captured by the Horde!', 'NULL', 'NULL', 'NULL'),
(20024, 'The Eastern Graveyard has been captured by the Alliance!', 'NULL', 'NULL', 'NULL'),
(20025, 'The Western Graveyard has been captured by the Alliance!', 'NULL', 'NULL', 'NULL'),
(20026, 'The Southern Graveyard has been captured by the Alliance!', 'NULL', 'NULL', 'NULL'),
(20027, 'The chamber has been breached! The Titan Relic is vulnerable!', 'NULL', 'NULL', 'NULL'),
(20028, 'The Gate of the Green Emerald was destroyed!', 'NULL', 'NULL', 'NULL'),
(20029, 'The Gate of the Blue Sapphire was destroyed!', 'NULL', 'NULL', 'NULL'),
(20030, 'The Gate of the Purple Amethyst was destroyed!', 'NULL', 'NULL', 'NULL'),
(20031, 'The Gate of the Red Sun was destroyed!', 'NULL', 'NULL', 'NULL'),
(20032, 'The Gate of the Yellow Moon was destroyed!', 'NULL', 'NULL', 'NULL'),
(20033, 'The Chamber of Ancient Relics is under attack!',  'NULL', 'NULL', 'NULL'),
(20034, 'The Gate of the Green Emerald is damaged!', 'NULL', 'NULL', 'NULL'),
(20035, 'The Gate of the Blue Sapphire is damaged!',  'NULL', 'NULL', 'NULL'),
(20036, 'The Gate of the Purple Amethyst is damaged!', 'NULL', 'NULL', 'NULL'),
(20037, 'The Gate of the Red Sun is damaged!', 'NULL', 'NULL', 'NULL'),
(20038, 'The Gate of the Yellow Moon is damaged!', 'NULL', 'NULL', 'NULL'),
(20039, 'The Horde won the first round, the Relic of Titan was no captured!', 'NULL', 'NULL', 'NULL'),
(20040, 'The Alliance won the first round, the Relic of Titan was no captured!', 'NULL', 'NULL', 'NULL'),
(20041, 'The Horde won the second round, the Relic of Titan was no captured!', 'NULL', 'NULL', 'NULL'),
(20042, 'The Alliance won the second round, the Relic of Titan was no captured!', 'NULL', 'NULL', 'NULL'),
(20043, 'Round 1 - Finished!', 'NULL', 'NULL', 'NULL'),
(20044, 'The game has ended in a draw!', 'NULL', 'NULL', 'NULL');
