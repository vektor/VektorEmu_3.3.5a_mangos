...
INSERT INTO `player_factionchange_achievements` VALUES ('1028', '1031', 'Desecrate the Horde is bonfires in Eastern Kingdoms', 'Desecrate the Alliance is bonfires in Eastern Kingdoms');
INSERT INTO `player_factionchange_achievements` VALUES ('1029', '1032', 'Desecrate the Horde is bonfires in Kalimdor', 'Desecrate the Alliance is bonfires in Kalimdor');
INSERT INTO `player_factionchange_achievements` VALUES ('1030', '1033', 'Desecrate the Horde\ is bonfires in Outland', 'Desecrate the Alliance is bonfires in Outland');
...
INSERT INTO `player_factionchange_achievements` VALUES ('1040', '1041', 'Ruin Hallow is End for the Horde by completing Sergeant Hartman is quests which involve crashing the wickerman festival and cleaning up the stinkbombs from Southshore', 'Ruin Hallow\'s End for the Alliance by completing Darkcaller Yanka\'s quests which involve going to Southshore, ruining the kegs with rotten eggs and tossing stinkbombs into the town');
...
INSERT INTO `player_factionchange_achievements` VALUES ('1279', '1280', 'Get completely smashed, put on your best perfume, throw a handful of rose petals on Sraaz and then kiss him. You will regret it in the morning', 'Get completely smashed, put on your best perfume, throw a handful of rose petals on Jeremiah Payson and then kiss him. You will regret it in the morning');
...
INSERT INTO `player_factionchange_achievements` VALUES ('1656', '1657', 'Complete the Hallow is End achievements listed below.', 'Complete the Hallow is End achievements listed below.');
...
INSERT INTO `player_factionchange_achievements` VALUES ('2770', '2771', 'Earn exalted status with and the right to represent every Alliance race faction in the Argent Tournament.', 'Earn exalted status with and the right to represent every Horde race faction in the Argent Tournament.');
...
INSERT INTO `player_factionchange_achievements` VALUES ('2782', '2788', 'Earn the right to represent every Alliance race  faction in the Argent Tournament.', 'Earn the right to represent every Horde race faction in the Argent Tournament.');
...
INSERT INTO `player_factionchange_achievements` VALUES ('2817', '2816', 'Earn exalted status with and the right to represent every Alliance race s faction in the Argent Tournament.', 'Earn exalted status with and the right to represent every Horde race  faction in the Argent Tournament.');
...
INSERT INTO `player_factionchange_achievements` VALUES ('3580', '3581', 'While wearing either a Pilgrim s Dress, Robe, or Attire, take a seat at each enemy capital s Bountiful Table.', 'While wearing either a Pilgrim s Dress, Robe, or Attire, take a seat at each enemy capital is Bountiful Table.');
...
INSERT INTO `player_factionchange_achievements` VALUES ('4786', '4790', 'You assisted High Tinker Mekkatorque and the Gnomeregan Exiles in the recapture of Gnomeregan s surface.', 'You assisted High Tinker Mekkatorque and the Gnomeregan Exiles in the recapture of Gnomeregan  surface.');
